...
func TestMain(m *testing.M) {
	// Fork change: point the credential lookups at a throwaway root rather than
	// unsetting them as upstream does. Unset, OpenCode falls back to its default
	// path under the developer's real home, which is the thing this is meant to
	// keep the tests away from.
